...
const FbIcon = () => {
  return (
    ...
    >
      <path
        d="M2.39582 18.9165H6.39582V11.0518H9.99982L10.3958 7.14404H6.39582V5.17051C6.39582 4.9101 6.50117 4.66036 6.68871 4.47623C6.87625 4.2921 7.1306 4.18865 7.39582 4.18865H10.3958V0.26123H7.39582C6.06973 0.26123 4.79797 0.778456 3.86028 1.69912C2.9226 2.61979 2.39582 3.86849 2.39582 5.17051V7.14404H0.395817L-0.000183105 11.0518H2.39582V18.9165Z"
        fill="currentColor"
      />
    </svg>
  );
...
const TwtIcon = () => {
  return (
    ...
    >
      <path
        d="M18.7058 1.97628C18.0179 2.2661 17.2789 2.46192 16.5021 2.55043C17.3036 2.09439 17.9034 1.37663 18.1893 0.531091C17.4362 0.956414 16.6119 1.25579 15.7524 1.41622C15.1743 0.829422 14.4087 0.440484 13.5744 0.309789C12.7401 0.179094 11.8837 0.313954 11.1383 0.693432C10.3928 1.07291 9.79998 1.67577 9.4518 2.40842C9.10363 3.14108 9.0196 3.96252 9.21276 4.74523C7.68676 4.67238 6.19393 4.29527 4.83114 3.63836C3.46834 2.98145 2.26606 2.05943 1.3023 0.93214C0.972766 1.47262 0.783284 2.09925 0.783284 2.76662C0.782916 3.36741 0.938522 3.95899 1.23629 4.48889C1.53407 5.01878 1.9648 5.4706 2.49027 5.80425C1.88086 5.78582 1.2849 5.62925 0.751978 5.34759V5.39459C0.751917 6.23721 1.05847 7.05391 1.61963 7.7061C2.18078 8.35829 2.96198 8.8058 3.83065 8.97269C3.26532 9.11816 2.67262 9.13959 2.0973 9.03536C2.34239 9.76039 2.8198 10.3944 3.4627 10.8486C4.1056 11.3029 4.8818 11.5546 5.68263 11.5685C4.32317 12.5832 2.64423 13.1336 0.915922 13.1312C0.609769 13.1313 0.303875 13.1143 -0.000183105 13.0803C1.75415 14.1528 3.79633 14.722 5.882 14.7197C12.9423 14.7197 16.8019 9.1599 16.8019 4.33792C16.8019 4.18126 16.7978 4.02303 16.7904 3.86637C17.5412 3.35016 18.1892 2.71093 18.7042 1.97863L18.7058 1.97628Z"
        fill="currentColor"
      />
    </svg>
  );
...
const DribbleIcon = () => {
  return (
    ...
    >
      <path
        d="M8.99982 0.26123C4.02912 0.26123 -0.000183105 4.29053 -0.000183105 9.26123C-0.000183105 14.2319 4.02912 18.2612 8.99982 18.2612C13.9705 18.2612 17.9998 14.2319 17.9998 9.26123C17.9998 4.29053 13.9705 0.26123 8.99982 0.26123ZM8.99982 1.56533C10.9605 1.56533 12.7501 2.29883 14.1091 3.50573C13.1106 4.82288 11.5936 5.69993 10.0735 6.29348C9.213 4.72628 8.2486 3.21842 7.18677 1.77998C7.78063 1.63683 8.3894 1.56478 9.00027 1.56533H8.99982ZM5.72562 2.29433C6.72912 3.79553 7.70112 5.18738 8.58897 6.76283C6.34347 7.34468 3.80592 7.69388 1.46187 7.69973C1.95597 5.30213 3.56652 3.31133 5.72562 2.29478V2.29433ZM14.9628 4.39583C16.0748 5.75481 16.6866 7.45441 16.6957 9.21038C14.9155 8.85938 13.1452 8.76758 11.3425 8.94938C11.14 8.44403 10.8943 7.96388 10.659 7.44638C12.2128 6.81953 13.8742 5.74673 14.9628 4.39538V4.39583ZM9.21402 7.95353C9.40662 8.36303 9.62982 8.79773 9.83952 9.24188C7.33302 10.3471 4.66677 11.824 3.28302 14.4133C1.95462 12.9433 1.24668 11.0162 1.30752 9.03578C3.99177 9.02318 6.62652 8.68748 9.21402 7.95353ZM13.2811 10.0519C14.4011 10.0521 15.5164 10.1958 16.5999 10.4794C16.4328 11.5217 16.0531 12.5185 15.4843 13.4078C14.9155 14.297 14.1699 15.0598 13.2937 15.6485C12.8806 13.7698 12.4869 11.972 11.7907 10.1594C12.2841 10.0875 12.7821 10.0514 13.2807 10.0514L13.2811 10.0519ZM16.6399 10.1914C16.6345 10.2355 16.6296 10.2787 16.6233 10.3219C16.6296 10.2782 16.635 10.235 16.6399 10.1914ZM10.3669 10.5109C11.0761 12.3437 11.6328 14.3732 12.0063 16.3483C11.0555 16.7517 10.0331 16.9589 9.00027 16.9576C7.2893 16.96 5.62674 16.3897 4.27752 15.3376C5.67117 13.0768 7.82982 11.3659 10.3665 10.5113L10.3669 10.5109Z"
        fill="currentColor"
      />
    </svg>
  );
...
const Footer = () => {
  return (
    <footer className="bg-black-light px-24 py-12">
      ...
      <hr className="my-8 border-t-2 border-solid border-red-primary" />
      <div className="xl:px-48 lg:px-24 px-0">
