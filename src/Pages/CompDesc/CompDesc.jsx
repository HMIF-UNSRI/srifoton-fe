          ...
          <li className="relative w-full mb-6 lg:mb-0">
            <div className="flex items-center">
              <div className="flex justify-center items-center w-6 h-6 bg-white rounded-full ring-0 ring-red-primary lg:ring-8 shrink-0">
                <svg aria-hidden="true" className="w-3 h-3 text-red-primary" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd"></path></svg>
              </div>
              <div className="hidden lg:flex w-full bg-red-primary h-0.5"></div>
            </div>
            <div className="mt-3 sm:pr-8">
              <h3 className="text-lg border-r-2 border-red-secondary font-semibold text-white">{el.name}</h3>
              <time className="block mb-2 text-sm border-r-2 border-red-primary font-normal leading-none text-white">{el.date}</time>
            </div>
          </li>
          ))}
