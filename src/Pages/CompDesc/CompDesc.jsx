        ...
        <ol class="items-center lg:flex w-full justify-center bg-primary-dark-main p-5 rounded-xl my-12">
          ...
          <li class="relative w-full mb-6 lg:mb-0">
            ...
            <div class="mt-3 sm:pr-8">
              <h3 class="text-lg border-r-2 border-red-secondary font-semibold text-white">{el.name}</h3>
              <time class="block mb-2 text-sm border-r-2 border-red-primary font-normal leading-none text-white">{el.date}</time>
            </div>
          </li>
          ))}
